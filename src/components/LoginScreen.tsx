    ...
    <div className="fixed inset-0 bg-[#0a0502] flex flex-col items-center justify-center z-40 p-6">
      ...
      >
        ...
        <button
          onClick={handleLogin}
          disabled={isLoading}
          className="w-full bg-white text-black font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-3 hover:bg-white/90 transition-colors disabled:opacity-50"
        >
